...
Customized By: @nrzmalik (www.nrzmalik.com)
...
var Sylvester = {
  ...
  var zoomPerformed = false;
      ...
      if (!zoomPerformed) {
          if (zoomTarget.hasClass("selectedZoomTarget")) {
              // If already zoomed, zoom back to root
              settings.root.click();
          } else {
              // If not zoomed, zoom to target
